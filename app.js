...
function rightPanelPopulate(allBooks, filter){
  ...
  for(var i=0; i<allBooks.length; i++){
    ...
    container.innerHTML+="<div class='col-md-4 col-sm-6 col-xs-12 tile' onmouseover='lightUp(event)' onmouseout='backToNormal(event)'>"+"<b><i>"+allBooks[i].title+"</i></b><br/>"+allBooks[i].author+"   <br/><b>"+filter+"</div>";
  ...
  for(var i=0; i<allBooks.length; i++){
    ...
    container.innerHTML+="<div class='col-md-4 col-sm-6 col-xs-12 tile' onmouseover='lightUp(event)' onmouseout='backToNormal(event)'>"+"<b><i>"+allBooks[i].title+"</i></b><br/>"+allBooks[i].author+"   <br/><b>"+bookTags+"</div>";
...
function backToNormal(event){
  event.target.style.cssText="background-color:skyblue";
}*/
